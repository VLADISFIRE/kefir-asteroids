...
Задание:
1. Необходимо разработать 2D клон оригинальнойигры Asteroids
...
Результат выполнения должен быть представлен в виде репозитория с Unity
2022.3+ проектом на GitHub.
